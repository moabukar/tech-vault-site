...
<ul>
<li>Absolute path: This is the path from the root directory. The root is the head honcho. The root directory is commonly shown as a slash. Every time your path starts with / it means you are starting from the root directory. For example, /home/mo/Desktop.</li>

<li>Relative path: This is the path from where you are currently in filesystem. If I was in location /home/mo/Documents and wanted to get to a directory inside Documents called taxes, I don’t have to specify the whole path from root like /home/mo/Documents/taxes, I can just go to taxes/ instead.</li>
</ul>
...
<pre>$ cd /home/mo/Pictures</pre> 

So now I've changed my directory location to /home/mo/Pictures.

Now from this directory I have a folder inside called Hawaii, I can navigate to that folder with:

<pre>$ cd Hawaii</pre>

Notice how I just used the name of the folder? It’s because I was already in /home/mo/Pictures.
...
<li>~ (home directory). This directory defaults to your “home directory”. Such as /home/mo.</li>
