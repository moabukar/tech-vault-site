...
<pre>$ dd if=/home/mo/backup.img of=/dev/sdb bs=1024 </pre>
...
<pre>$ dd if=/home/mo/backup.img of=/dev/sdb bs=1M count=2</pre>
...
<details>
<summary>What is the dd option for block size?</summary>
bs
</details>
